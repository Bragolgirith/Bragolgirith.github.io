                ...
                $(".submit_form").on('click', function (e) {
                    ...
                    $fields.each(function () {
                        ...
                        if ($field.hasClass('required') && $field.val() === "") {
                            ...
                            if ($field.hasClass('radio-lilac')) {
                                var radiofieldName = $field.data("value");
                                formFields[radiofieldName] = $('.active', $field).data("value");
                            } else {
                    ...
                    if (!error && !$tis.sendingMail) {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: 'https://script.google.com/macros/s/AKfycbx5lq0CmT-fU--Kmfjcr7ntMOHf_a8NA7cC7UHD1dfbhTF7aftU/exec',
                            data: formFields,
                            dataType: 'jsonp',
