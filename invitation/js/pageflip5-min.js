...
var _gaq = _gaq || [];
(function (hG, hF, hE) {
    var hD, hC, hB, hA, hz, hy, hj, hh, hf, hd, hb, g9, g7, g6, g5, g3, g1, gZ, gX, gV, gT, gS, go, gm, gk, gi, gg, ge,
        gH, gG, gF, gD, gB, gz, gx, gv, gt, gs, fS, fQ, fO, fM, fK, fI, gb, ga, f9, f7, f5, f3, f1, fZ, fX, fW, fm, fk,
        fi, fg, fe, fc, fF, fE, fD, fB, fz, fx, fv, ft, fr, fq, eB, ez, ex, ew, ev, eu, e4, e2, e0, eX, eU, eR, eP, eN,
        eL, eK, dQ, dN, dL, dK, dJ, dI, eo, em, ek, eh, ee, eb, d9, d7, d5, d4, c3, c0, cY, cX, cW, cV, dz, dw, dt, dq,
        dn, dl, dk, dj, di, dh, ch, ce, cc, cb, ca, b9, cM, cJ, cG, cD, cB, cz, cy, cx, cw, cv, bv, bs, bq, bp, bo, bn,
        b0, bX, bU, bR, bP, bN, bM, bL, bK, bJ, aT, aQ, aO, aN, aM, aL, hx, hw, hv, hu, ht, hs, hr, hq, hp, ho, g4,
        g2 = "ontouchstart" in hF, g0 = {a: "touchstart", b: "touchmove", c: "touchend"},
        gY = {a: "mousedown", b: "mousemove", c: "mouseup"}, gW = Math, gU = gW.PI, hn, hm = ["left", "right"],
        hl = false, hk = true, hi = gW.sin, hg = gW.asin, he = gW.cos, hc = gW.sqrt, ha = gW.abs, g8 = gW.floor,
        gE = gW.ceil, gC = gW.round, gA = gW.random, gy, gw, gu, gR, gQ = "toUpperCase", gP = "charCodeAt",
        gO = "length", gN = "get", gM = "UTC", gL = gN + gM, gN = gL + "FullYear", gM = gL + "Month", gL = gL + "Date",
        gK = "location", gJ = "href", gI = "offline", f8 = "online", f6 = "split", f4 = "substr", f2 = "http:",
        f0 = "www", fY = "/", gr = "fromCharCode", gq = "top", gp = "auto", gn = 85, gl = gn * 3, gj = gl + 1, gh = 6,
        gf = 8, gd = 1000, gc = 50, fC = gj >> 2, fA, fy, fw,
        fu = '<svg version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="26px" height="40px" viewBox="0 0 26 40" xml:space="preserve"><g><path d="M21.544,0.515c-0.688-0.687-1.801-0.687-2.488,0L0.815,18.756c-0.687,0.687-0.687,1.8,0,2.488l18.241,18.241 c0.688,0.687,1.801,0.687,2.488,0l3.938-3.938c0.688-0.688,0.688-1.801,0-2.488L12.397,20.026L25.481,6.94 c0.688-0.686,0.688-1.8,0-2.487L21.544,0.515z"/></g></svg>',
        ...
        fV = function (hI) {
            ...
            e4 = hI.TearDistance || 100, e2 = bs ? hI.PerformanceAware || hl : hk, e0 = c3 ? "#~# \u2013 #" : (hI.PagerText || "Стр. #~Стр. #-#"), hH = hI.PagerSkip, eX = hH == hE ? hk : hH, eU = hI.HideCopyright || hl, eo = hI.HashControl || hl, hH = hI.ZoomEnabled, eR = hH == hE ? hk : hH, eP = hI.ClickZoom || hl, hH = hI.ZoomFlip, eN = hH == hE ? hk : hH, hH = hI.PinchZoom, eL = hH == hE ? hl : hH, hH = hI.HotKeys, eK = hH == hE ? hk : hH, hH = hI.MouseControl, dQ = hH == hE ? hk : hH, dN = hI.GoogleAnalytics, dL = hI.ShareLink || "http://pageflip-books.com", dK = hI.ShareText || "Pageflip5, The Book Template for the Web", dJ = hI.ShareVia || "@MaccPageFlip", dI = hI.ShareImageURL, em = hI.Copyright, ek = hI.FWCopyright || em, eh = hI.ShowCopyright || hl, ee = hI.Key, eb = hk, d7 = hI.Preview ? "?" + gC(gA() * 10000) : "", d5 = hI.DisableSelection || hl, hH = hI.ShareOnTwitter, cX = hH == hE ? hk : hH, hH = hI.ShareOnFacebook, cW = hH == hE ? hk : hH, hH = hI.ShareOnPinterest, cV = hH == hE ? hk : hH, hH = hI.ShareOnGoogle, dz = hH == hE ? hk : hH;
            dw = gb;
            dt = g9;
            dq = gF;
            dn = ez;
            ...
            hN = hN || hl;
            hL = hL || hl;
            var hK = hO.data(), hI = hK.disableEmbossing, hJ = {
                a: !(hK.unload == hl),
                w: hK.backgroundFile,
                r: hK.htmlFile,
                s: hO.html(),
            ...
            if (hU && hW[4] == 1) {
                var hS = d2(), hR = (2 * gd + hW[5]) * gd + (hW[6]) * gc + hW[7],
                    hQ = (hS[gN]()) * gd + (hS[gM]() + 1) * gc + hS[gL]();
                // Date check //hU = hQ <= hR
                hu = true
            }
            if (hU) {
                var hO = hF[gK][gJ][f6](fY), hM, hL;
                if (hO[0] == f2) {
                    hM = hO = hL = gI
                } else {
                    hO = hO[2];
                ...
                var hK = hW[4] == 1 ? 8 : 5;
                if (hU = compareFp(eM(escape(em)), {a: hW[hK++], b: hW[hK++]})) {
                    var hJ = eM(escape(hO)[f6]("%3A")["join"](":")), hI = eM(escape(hM)[f6]("%3A")["join"](":")),
                        hP = eM(escape(hL)), hN = hW[hK++];
                    while (hN-- && !(hU = (compareFp(hJ, {a: hW[hK], b: hW[hK + 1]}) || compareFp(hI, {
                        a: hW[hK],
                        b: hW[hK + 1]
                    }) || compareFp(hP, {a: hW[hK++], b: hW[hK++]})))) {
                    }
                }
                if (hU) {
                    gw = gn + 10;
            ...
            return {a: hL & gl, b: fj((hK + hH) & gl)}
        }, compareFp = function (hI, hH) {
            // Disable security
            return true;
            ...
            var hK = 0, hJ = 0, hM = 0, hN = [], hH = hI[gO], hL = g8((hH * 6) / 8);
            hI.push(hK, hJ);
            while (hJ++ < hL) {
            ...
            var hI = ev - ((g9 && !fK) ? gC((d6 - ea) / 2) : 0), hH = eu - ((g9 && fK) ? gC((d6 - ea) / 2) : 0);
            if (cB == hI && cz == hH) {
                return
            }
            bv = hk;
            cB = hI, cz = hH;
            ce.css({transform: ah(cB, cz)})
        }, eF = function () {
            var hM = hu, hL = hr, hK = [], hJ = [], hI = [], hH = [], ih = [], ig = cM, ie = cM + 1;
            ea = d6 = ei = ec = 0;
            bo = [];
            if (bp) {
                if (b0 < 0) {
            ...
            hr = [];
            var h0 = ig, hZ = hv[h0]["l"], hY = hZ ? fc : 0;
            while (h0 >= 0) {
            ...
            hu = [];
            var hW = hK.length, ib = hJ.length, ia = hW > ib ? hW : ib, h9, hT;
            ...
            for (var ic = 0, h7, h6, h5, h4, h3, h2, hS, hR, hQ, hP; ic < hI.length; ic++) {
                ...
                if (hQ >= 0) {
                    ...
                    h6.css({position: "absolute", overflow: "hidden", width: h4, height: h3, top: h2, left: hS, right: hR});
                    h5 = hv[h7]["$c"] = a4(h7);
                    if (hv[h7]["w"]) {
            ...
            var hJ = hv[hI], hH = hJ["$p"], hL = hJ.e, hK = hJ.f;
            hH.unwrap();
            hH.css({
            ...
            if (fK) {
                cc.css({transform: ah(0, cD / 2 - hJ) + "scaleY(" + hH + ")"})
            } else {
                cc.css({transform: ah(cG / 2 - hJ, 0) + "scaleX(" + hH + ")"})
            }
            ...
            hH = hH || hU;
            hS = hS || hT;
            var hR = bn.length, hP = bR, hK = hK || 2, hM = hM || 0;
            if (hR >= bN) {
                return hl
            }
            if (hR == 0) {
            ...
            var hN = hP + (hO > 0 ? 1 : 0), hL = hP + (hK - (hO < 0 ? 1 : 0)) * hO, hJ;
            if (hv[hN]["p"] || hv[hL]["p"]) {
                hJ = 2
            } else {
                hJ = hM
            ...
            bP = hP + hK * hO;
            var hI = bX == 1;
            bn[hR] = dB({j: bR, v: bP, k: hI ? hL : hN, w: hI ? hN : hL, t: hQ, s: bX, y: hO, l: hl, e: hl}, hU, hT);
            eF();
            if (hH || hS) {
                dy(bn[hR], hH * fw, hS)
            }
            ...
            var hH = hK.k, hL = hK.w, hJ = hv[hH]["$p"], hI = hv[hL]["$p"];
            hv[hH]["t"] = hv[hH]["y"] = hv[hL]["t"] = hv[hL]["y"] = hl;
            hI.css({transform: ah(0, 0) + "rotate(0deg) "});
            hJ.css({transform: ah(0, 0) + "rotate(0deg) "})
        }, dD = function (hI) {
            var hH = bn[hI];
            if (!hH.e) {
                aO = hl
            ...
            var hK = hL.w, hM = hv[hK]["e"], hJ = hv[hK]["f"];
            if (hL.t == 2) {
                if (fK) {
                    hI *= hJ * hL.y / hH;
                    hH = hJ * hL.y;
            ...
            hM = hM || hO.Q;
            hK = hK || hO.H;
            var hH = hO.k, iD = hO.w, hN = hv[hH]["$p"], iC = hv[hH]["$m"], hL = hv[iD]["$p"], ih = hv[iD]["$m"],
                ij = hv[hH]["e"], ii = hv[hH]["f"], ig = ij / 2, ie = ii / 2, hJ = b0 * (bX == 1 ? -1 : 1), id = hO.d,
                ic = hO.c, ib = hO.A, iv = hO.z,
                iu = fK ? (hK == hO.u ? hE : (hK < hO.u ? -1 : 1)) : (hM == hO.u ? hE : (hM < hO.u ? -1 : 1));
            hO.u = fK ? hK : hM;
            if (bX != 2) {
                if (fK) {
                    var it = hc(hK * hK + (ig + hM) * (ig + hM)), ir = hc(hK * hK + (ig - hM) * (ig - hM)),
                        iq = hc(ii * ii + (ig + id) * (ig + id)), ip = hc(ii * ii + (ig - id) * (ig - id));
                    if ((it > iq || ir > ip) && hO.t != 5) {
                        if (((it - iq) > e4 || (ir - ip) > e4) && hv[hO.k]["d"] && hO.t == 2) {
                            hO.t = 5;
                            var io = hK * 2, im = hM < 0 ? -ij * 1.5 : ij * 1.5;
                            dv(hO, im, io, ex, 2, 0)
                        } else {
                            if (hM < id) {
                                var hP = ig - hM, hQ = hg(hP / ir);
                                hM = ig - hi(hQ) * ip;
                    ...
                    var it = hc(hM * hM + (ie + hK) * (ie + hK)), ir = hc(hM * hM + (ie - hK) * (ie - hK)),
                        iq = hc(ij * ij + (ie + ic) * (ie + ic)), ip = hc(ij * ij + (ie - ic) * (ie - ic));
                    if ((it > iq || ir > ip) && hO.t != 5) {
                        if (((it - iq) > e4 || (ir - ip) > e4) && hv[hO.k]["d"] && hO.t == 2) {
                            hO.t = 5;
                            var im = hM * 2, io = hK < 0 ? -ii * 1.5 : ii * 1.5;
                            dv(hO, im, io, ex, 0, 2)
                        } else {
                            if (hK < ic) {
                                var hP = ie - hK, hQ = hg(hP / ir);
                                hK = ie - hi(hQ) * ip;
            ...
            if (bX == 2) {
                var hJ = b0 * (il < 0 ? 1 : -1), ik = gy * b0, hW = fK ? "rotateX" : "rotateY", hZ = 3000;
                if (hJ < 0) {
                    if (bs) {
                        hN.css({transform: hW + "(" + ((gw + ik + il) * fw) + "deg) " + ah(0, 0), opacity: 1});
                        hL.css({transform: hW + "(" + (gy) + "deg) " + ah(hZ, hZ), opacity: 1})
                    } else {
                        var hV = -(gy - ha(il)) / 5 * b0;
                        hN.css({transform: fK ? "scaleY(" + hi(b0 * il / hn) + ") skewX(" + hV + "deg) " + ah(0, 0) : "scaleX(" + hi(b0 * il / hn) + ") skewY(" + hV + "deg) " + ah(0, 0)});
                        hL.css({transform: ah(hZ, hZ)})
                    }
                } else {
                    if (bs) {
                        hL.css({transform: hW + "(" + ((gw - ik + il) * fw) + "deg) " + ah(0, 0), opacity: 1});
                        hN.css({transform: hW + "(" + (gy) + "deg) " + ah(hZ, hZ), opacity: 1})
                    } else {
                        var hV = (gy - ha(il)) / 5 * b0;
                        hL.css({transform: fK ? "scaleY(" + hi(-b0 * il / hn) + ") skewX(" + hV + "deg) " + ah(0, 0) : "scaleX(" + hi(-b0 * il / hn) + ") skewY(" + hV + "deg) " + ah(0, 0)});
                        hN.css({transform: ah(hZ, hZ)})
                    }
                }
                if (!fF) {
                    if (hJ < 0) {
                ...
                if (fK) {
                    var hU = id - hM, hT = ic - hK, hS = id - ib, hR = ic - iv, h9 = hc(hU * hU + hT * hT),
                        hQ = hg(hU / h9) || 0, h8 = hc(hS * hS + hR * hR), hP = hg(hS / h8);
                    if (hT < 0 || (hT == 0 && hJ < 0)) {
                        hQ = gU - hQ
                    }
                    if (hR < 0) {
                    ...
                    hP = hQ - (hP - hQ);
                    var h7 = he(hP) * h8 + hK, h6 = hi(hP) * h8 + hM, h5 = (h6 - ib) / 2, h4 = (h7 - iv) / 2, h2 = ib + h5,
                        h0 = iv + h4, ia = hc(h5 * h5 + h4 * h4);
                    if (h4 < 0) {
                        ia *= -1
                    }
                    var hY = hQ * hn;
                    var hX = 6;
                    hL.css({transform: ah(0, ((ie + ia) * hJ)["toFixed"](hX)) + "rotate(" + (hY) + "deg) "});
                    ih.css({transform: ah(-h2.toFixed(hX), h0.toFixed(hX)) + "rotate(" + (hY) + "deg)"});
                    hN.css({transform: ah(-(hi(-hQ) * hJ)["toFixed"](hX), ((-ie - ia + 1 * he(-hQ)) * hJ)["toFixed"](hX)) + "rotate(" + (-hY) + "deg) "});
                    iC.css({transform: ah((-h2)["toFixed"](hX), (h0 - 1 * hJ)["toFixed"](hX)) + "rotate(" + (hY) + "deg)"});
                    var iB = ha(he(hQ) * ie) - ia * hJ, iA = hi(-hQ) * ig + iB, iz = hi(hQ) * ig + iB, iy = (iA + iz) / 2,
                        ix = 1;
                    iB = iA > iz ? iA : iz;
                    hO.n = iB;
                    if (!fF) {
                    ...
                    var hU = id - hM, hT = ic - hK, hS = id - ib, hR = ic - iv, h9 = hc(hU * hU + hT * hT),
                        hQ = hg(hT / h9) || 0, h8 = hc(hS * hS + hR * hR), hP = hg(hR / h8);
                    if (hU < 0 || (hU == 0 && hJ < 0)) {
                        hQ = gU - hQ
                    }
                    if (hS < 0) {
                    ...
                    hP = hQ - (hP - hQ);
                    var h6 = he(hP) * h8 + hM, h7 = hi(hP) * h8 + hK, h5 = (h6 - ib) / 2, h4 = (h7 - iv) / 2, h2 = ib + h5,
                        h0 = iv + h4, ia = hc(h5 * h5 + h4 * h4);
                    if (h5 < 0) {
                        ia *= -1
                    }
                    var hY = hQ * hn;
                    var hX = 6;
                    hL.css({transform: ah(((ig + ia) * hJ)["toFixed"](hX), 0) + "rotate(" + (hY) + "deg) "});
                    ih.css({transform: ah(h2.toFixed(hX), h0.toFixed(hX)) + "rotate(" + (hY) + "deg)"});
                    hN.css({transform: ah(((-ig - ia + 1 * he(-hQ)) * hJ)["toFixed"](hX), (hi(-hQ) * hJ)["toFixed"](hX)) + "rotate(" + (-hY) + "deg) "});
                    iC.css({transform: ah((h2 - 1 * hJ)["toFixed"](hX), (h0)["toFixed"](hX)) + "rotate(" + (hY) + "deg)"});
                    var iB = ha(he(hQ) * ig) - ia * hJ, iA = hi(-hQ) * ie + iB, iz = hi(hQ) * ie + iB, iy = (iA + iz) / 2,
                        ix = 1;
                    iB = iA > iz ? iA : iz;
                    hO.n = iB;
                    if (!fF) {
            ...
            var hL = d2()["getTime"]() - hH.m, hN = hH.x, hK = hl;
            if (hL >= hN) {
                hK = hk;
                hL = hN
            }
            var hJ = hL / hN, hP = hH.b - hH.i, hO = hH.a - hH.h, hI = hH.i + d3(hH.g, hJ, hP, hH.p),
                hM = hH.h + d3(hH.f, hJ, hO, hH.p);
            return {x: hI, y: hM, end: hK}
            ...
            var hN = hl, hM = fK ? -0.5 : hL, hK = fK ? hL * 2 : 1;
            ...
            if (ey(hH, 4)) {
                ...
                var hI = br(bM, bL, aT || aQ), hN = aK(bM, bL);
                if (!d0 && (hI || hN)) {
                    hH.e = fq
                }
                aQ = aT = hl;
                var hK = hH.d * (fK ? 1 : (hH.e ? -1 : 1) * hH.o * hO), hL = hH.c * (fK ? (hH.e ? -1 : 1) * hH.o * hO : 1),
                    hR = fK ? cD : cG, hQ = ag(hK - hH.Q, hL - hH.H) / hR, hP = hH.n / hR, hM = 2;
                if (hP > hQ) {
                    hQ = hP, hM = 1
                }
            ...
            return -1
        }, ct, cs, cr, cp, cn, cl, cj, cg = 0, cd = 0, bk, bi, bg, be = function () {
            var hI = c9[b4(bW[0])]["b"], hH = c9[b4(bW[1])]["b"];
            ...
            var hK = cy + M * ab, hI = (hJ.pageX - dh.offset()["left"]) / hK - cG / 2 - cB,
            ...
            var hI = hJ.pageX - di.offset()["left"], hH = hJ.pageY - di.offset()["top"];
            return {x: hI, y: hH}
            ...
            if (gk) {
                di.css({width: "100%", height: "100%"})
            } else {
                if (hh == hE) {
                    di.css({width: gm ? "100%" : cG + (cG > gZ ? g3 + g1 : gS + go)})
                } else {
                    di.css({width: hh})
                }
                if (hf == hE) {
                    di.css({height: gm ? "100%" : cD + (cG > gZ ? g6 + g5 : gV + gT)})
                } else {
                    di.css({height: hf})
                }
            ...
            an();
            aq();
            dh.css({position: "relative", top: 0, left: 0});
            ch.css({"transform-style": "preserve-3d", opacity: 1});
            ce.css({position: "absolute", top: 0, left: 0, "z-index": 10});
            if (fE) {
                cc.css({
                    position: "absolute",
                    top: 0,
            ...
            if (gk) {
                hG(dj)["css"]({width: hF.innerWidth, height: hF.innerHeight})
            }
            if (gk || gm) {
                var hV = ge;
                if (hV && bY) {
                ...
                var hT = hh - az - ax, hS = hV ? cD : hf - av - at, hR = gF ? hy : cG, hP = gF ? hj : cD, hQ = hT / hR,
                    hO = hS / hP;
                if (gH) {
                    var hN = hQ < hO ? hQ : hO;
                    var hM = cD * hN + av + at;
            ...
            dh.css({"margin-top": av, "margin-left": az, "margin-bottom": at, "margin-right": ax})
        }, an = function () {
            dh.css({width: cG, height: cD});
            ce.css({width: cG, height: cD});
            if (fE) {
                cc.css({width: cG, height: cD})
            }
        }, R, Q, P = function () {
            var hJ = cy + M * ab, hI = R + Y * ab + cg, hH = Q + X * ab + cd;
            dh.css({transform: ah(hI, hH) + "scale(" + hJ + "," + hJ + ")"})
        }, O = function () {
            var hP = hh - az - ax, hO = hf - av - at, hN = hP / cG, hM = hO / cD, hJ = hN > hM ? hM : hN, hL = hP / hy,
                hK = hO / hj, hI = hL > hK ? hK : hL;
            if (hI > 1) {
                hI = 1
            }
            if (hJ > 1) {
            ...
            var hO = hK - R - cG / 2 - hL - az - cB, hI = hM - Q - cD / 2 - hJ - av - cz;
            var hN = (hH ? {x: hO, y: hI} : F(hO, hI));
            Y = W = hN.x;
            X = V = hN.y
        }, C, l = function () {
            var hL = location.hash, hK, hJ;
            if (hL == "") {
                hL = (c3 ? "#" : "#page/") + gz
            }
            if (hL) {
            ...
            if (cW) {
                ...
                hG("#b-facebook")["css"]({display: "none"})
            }
            if (cV) {
                ...
                hG("#b-pinterest")["css"]({display: "none"})
            }
            if (dz) {
            ...
            if (fS) {
                ...
                hG("#b-fullscreen")["css"]({display: "none"})
            }
            ...
            var hU = hv[cM], hT = hU.i, hS = hU.h, hQ = hv[cM + 1], hN = hQ.i, hL = hQ.h, hK = hT ? hT : (hS > 0 ? hS : hE),
                hJ = hN ? hN : (hL > 0 ? hL : hE), hH = (hK > 0 && hJ > 0 && (!hT && !hN)) ? 1 : 0,
                hR = e0.split("~")[hH]["split"]("#"), hP = "", hI = "";
            if (!hK) {
                hK = hJ;
                hT = hN;
                hJ = hE
            ...
            hI = encodeURI(hI);
            b9.val(hP);
            var hO = (cM > (gx + 1)) && !bK, hM = (cM < (gv - 1)) && !bK;
            m(hG("#b-first"), hO);
            m(hG("#b-prev"), fM || hO);
            m(hG("#b-next"), fM || hM);
            m(hG("#b-last"), hM);
            ...
            var hJ = "pageflip-thumbnails", hS = "pf-thumbnail-container";
            if (a) {
                a.remove()
            }
            ...
            dc = 0;
            da = 0;
            var hR = "pf-thumbnail", hQ = "-", hL = "page", hP = "spread", hO = "button", hM = hR + hQ + hL,
                hK = hR + hQ + hP, hI = hR + hQ + hO, hH = "#" + hR;
        ...
        }, e6 = hl, e5 = hl, e3 = 0, e1 = 0, eZ = function (hH) {
            if (!c4) {
                switch (hH.target["id"]) {
                    case"pf-thleft":
                        e1 = 1;
            ...
            var hK = g8(hh / 2), hI, hH = e.length - 1, hJ = d.lastIndexOf(cM);
            if (fi) {
                ed = hK - e[0];
                eg = hK - e[hH]
            } else {
            ...
            if (f1 && !(ha(da - c8) < 32)) {
                c8 = da;
                var hM = -fm - 32, hI = hh + fm + 32, hH = b.length, hJ = 0;
    ...
    hG.extend(hG.fn, {pageflipInit: ae, pageflip: ai})
})(jQuery, this);